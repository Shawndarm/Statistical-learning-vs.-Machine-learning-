...
libname Lib "C:\Users\dutau\Downloads\SAS project\DGP_Outliers\Elasticnet";
...
model y = X1-X50 / selection = Elasticnet(choose = CV stop=CV);      /*Training on the first 50 variables */
run;
