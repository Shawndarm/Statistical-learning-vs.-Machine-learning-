...
libname Lib "C:\Users\dutau\Downloads\SAS project\DGP_Outliers\Backward";
...
model y = X1-X50 / selection = Backward(choose = AIC stop=CV);      /*Training on the first 50 variables */
run;
...
model y = X1-X50 / selection = Backward(choose = AICC stop=CV);      /*Training on the first 50 variables */
run;
...
model y = X1-X50 / selection = Backward(choose = CP stop=CV);      /*Training on the first 50 variables */
run;
