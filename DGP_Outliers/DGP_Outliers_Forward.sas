...
libname Lib "C:\Users\dutau\Downloads\SAS project\DGP_Outliers\Forward";
...
do i = 1 to 3 ; 
	do j = 1 to 100;
		b = ranuni(1);
		if b < 0.2 then X[j,i]= rand('normal',2,1); 
		/* 20% chance to get outliers among the first 3 features */
		else X[j,i]= X[j,i];
	end;
end;
