...
libname Lib "C:\Users\dutau\Downloads\SAS project\DGP_Outliers\Lasso";
...
model y = X1-X50 / selection = Lasso(choose = SBC stop=SBC);          /*Training on the first 50 variables */
run;
