...
libname Lib "C:\Users\dutau\Downloads\SAS project\DGP_intercorr\Forward";
...
model y = X1-X50 / selection = Forward(choose = AIC stop=SBC);      /*Training on the first 50 variables */
run;
...
model y = X1-X50 / selection = Forward(choose = SBC stop=SBC);          /*Training on the first 50 variables */
run;
...
model y = X1-X50 / selection = Forward(choose = AICC stop=SBC);      /*Training on the first 50 variables */
run;
...
model y = X1-X50 / selection = Forward(choose = CP stop=SBC);      /*Training on the first 50 variables */
run;
