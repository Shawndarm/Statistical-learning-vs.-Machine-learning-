...
libname Lib "C:\Users\dutau\Downloads\SAS project\DGP_intercorr\Backward";
...
model y = X1-X50 / selection = Backward(choose = AIC stop=SBC);      /*Training on the first 50 variables */
run;
...
model y = X1-X50 / selection = Backward(choose = SBC stop=SBC);          /*Training on the first 50 variables */
run;
...
model y = X1-X50 / selection = Backward(choose = AICC stop=SBC);      /*Training on the first 50 variables */
run;
...
model y = X1-X50 / selection = Backward(choose = CP stop=SBC);      /*Training on the first 50 variables */
run;
